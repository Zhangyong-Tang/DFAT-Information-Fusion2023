            ...
            for idx, (img, gt_bbox) in enumerate(video):
                ...
                if args.vis and idx > frame_counter:
                    ...
                    if cfg.MASK.MASK:
                        ...
                        cv2.polylines(img, [location_int.reshape((-1, 1, 2))], True, (0, 255, 255), 3)
                    ...
                    asr = min(600/img.shape[0], 800/img.shape[1])
                    img = cv2.resize(img, (int(img.shape[0]*asr), int(img.shape[1]*asr)))
